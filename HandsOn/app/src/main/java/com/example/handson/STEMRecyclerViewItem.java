...
public class STEMRecyclerViewItem {
    ...
    public STEMRecyclerViewItem(String question){
    ...
    public boolean isCheckButton(){
        if(checkButton1==true||checkButton2==true||checkButton3==true||checkButton4==true||checkButton5==true){
            return true;
        }
        return false;
    }
    ...
    public void setCheckButton5(boolean checkButton5) {
        this.checkButton5 = checkButton5;
    }
